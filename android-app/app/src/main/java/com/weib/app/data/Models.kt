...
data class LoginRequest(val username: String, val password: String, val captcha: String)
data class MobileUser(val id: Long, val username: String, val nickname: String?, val avatar: String?, val role: String)
